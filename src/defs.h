...
#define SHOW_CODE_CIGAR 5	/* encoded alignment */
#define SHOW_CODE_MASK  7	/* use higher bits for annotation format */
#define SHOW_CODE_EXT   8	/* encode identity, mismatch state */
#define SHOW_ANNOT_FULL 9	/* show full-length annot in calc_code */
