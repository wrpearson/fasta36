...
../bin/fasta36 -q -m 6 -Z 100000 ../seq/mgstm1.aa:1-100 /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.ok2.html
../bin/fasta36 -S -q -z 11 -O results/test_m1.ok2_p25 -s P250 ../seq/mgstm1.aa:100-218 q
echo "done"
echo "starting fastxy36" `date`
../bin/fastx36 -m 9c -S -q ../seq/mgtt2_x.seq /rdlib/slib2/fa_dbs/qfo20_pfam.lseg 1 > results/test_t2.xk1
../bin/fasty36 -S -q ../seq/mgtt2_x.seq /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_t2.yk2
...
../bin/fastx36 -m 9c -q -m 5 ../seq/mgstm1.rev /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.xk2r
../bin/fasty36 -q -m 5 -M 200-300 -z 2 ../seq/mgstm1.rev /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.yk2rz2
../bin/fasty36 -q -m 5 -z 11 ../seq/mgstm1.rev /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.yk2rz11
echo "done"
echo "starting ssearch36" `date`
../bin/ssearch36 -m 9c -S -z 3 -q ../seq/mgstm1.aa  /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.ssz3
../bin/ssearch36 -q -M 200-300 -z 2 -Z 100000 -s P250 ../seq/mgstm1.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.ss_p25
echo "done"
if [ -e ../bin/ssearch36s ]; then
    echo "starting ssearch36s" `date`
    ../bin/ssearch36s -m 9c -S -z 3 -q ../seq/mgstm1.aa  /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.sssz3
    ../bin/ssearch36s -q -M 200-300 -z 2 -Z 100000 -s P250 ../seq/mgstm1.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.sss_p25
    echo "done"
fi
...
../bin/ggsearch36 -q -m 9i -w 80 ../seq/hahu.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_h1.gg
../bin/glsearch36 -q -m 9i -w 80 ../seq/hahu.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_h1.gl
../bin/ggsearch36 -q ../seq/gtt1_drome.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_t1.gg
../bin/glsearch36 -q ../seq/gtt1_drome.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_t1.gl
echo "done"
...
../bin/fastf36 -q ../seq/m1r.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_mf.ff
../bin/fastf36 -q ../seq/m1r.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_mf.ff_s
echo "done"
echo "starting tfastf36" `date`
../bin/tfastf36 -q ../seq/m1r.aa %r > results/test_mf.tfr
echo "done"
echo "starting fasts36" `date`
../bin/fasts36 -q -V '*?@' ../seq/ngts.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.fs1
../bin/fasts36 -q ../seq/ngt.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.fs
../bin/fasts36 -q -n ../seq/mgstm1.nts m > results/test_m1.nfs
echo "starting fastm36" `date`
../bin/fastm36 -q ../seq/ngts.aa /rdlib/slib2/fa_dbs/qfo20_pfam.lseg > results/test_m1.fm
